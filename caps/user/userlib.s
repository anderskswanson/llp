...
#--------------------------------------------------------------------------
# print the IPC buffer: 
#--------------------------------------------------------------------------
	#System call to print the IPC buffer if its exists
	.globl printBuffer
printBuffer:
	movl	4(%esp), %ecx
	int	$155
...
# Retype memory: 
#--------------------------------------------------------------------------
	#system call to retype existing memory
	.globl retype
retype:
	movl	4(%esp), %ecx
	movl	8(%esp), %eax
...
#--------------------------------------------------------------------------
# create new IPC buffer: 
#--------------------------------------------------------------------------
	#System call to allocate a new IPC buffer if it exists. 
	.globl allocBuffer
allocBuffer:
	movl	4(%esp), %ecx #cap
	movl	8(%esp), %eax #addr
	...
	ret	
#--------------------------------------------------------------------------
# remaining unallocated memory:
#--------------------------------------------------------------------------
        #System call to get the remaining unallocated memory
	.globl	remaining 
remaining:
	movl	4(%esp), %ecx
	int	$153
...
#--------------------------------------------------------------------------
	...
	#System call to get the current tick coutn
	.globl getTicks
getTicks:
	movl    4(%esp), %ecx
	int	$152
